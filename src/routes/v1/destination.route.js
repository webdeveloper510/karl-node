...
router.route('/addsection').put(destinationController.createDestinationSection);
router.route('/create').put(destinationController.createDestination);
router.route('/updateSection').put(destinationController.updateDestinationSection);
router.route('/update').put(destinationController.updateDestination);
